  ...
  return (
    <div className="appDropdown">
      <button className="appButton" onClick={toggleDropdown}>
        <span className="buttonText">Get Brainheaters App</span>
        <div className="icons">
          <img src="/images/android.png" alt="Android Icon" className="buttonIcon" />
          <span className="separator"></span>
          <img src="/images/apple.png" alt="Apple Icon" className="buttonIcon" />
        </div>
      </button>
      ...
      {dropdownOpen && (
        <div className="dropdownContent">
          <a href="#" className="dropdownLink">
            <img src="/images/android.png" alt="Android Icon" className="dropdownIcon" />
            Download for Android
          </a>
          <span className="separatorHorizontal"></span>
          <a href="#" className="dropdownLink">
            <img src="/images/apple.png" alt="Apple Icon" className="dropdownIcon" />
            Download for iOS
          </a>
